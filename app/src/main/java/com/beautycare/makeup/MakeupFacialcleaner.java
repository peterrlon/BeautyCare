 ...
 */
public class MakeupFacialcleaner  extends Fragment implements BGARefreshLayout.BGARefreshLayoutDelegate{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup view = (ViewGroup) inflater.inflate(R.layout.makeup_facialcleaner, container, false);
        initImageLoader(getActivity());
        return view;
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        initImageLoader(getActivity());
        new makeup_facialcleaner_readdata().execute();
    }
    ...
    public class makeup_facialcleaner_readdata extends AsyncTask<Void,Void,ArrayList<MakeupData>> {
        ...
        protected ArrayList<MakeupData> doInBackground(Void...params){
            try {
                ...
                List<AVObject> result = query.whereEqualTo("category","facialcleaner").find();//查询并传数据到result
